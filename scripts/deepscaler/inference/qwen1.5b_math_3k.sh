...
python3 -m verl.trainer.main_ppo \
    ...
    data.val_files=$HOME/yangzhch6/projs/criticRL/TreeRPO-v4/data/train/MATH_cot_train.parquet \
    ...
    trainer.experiment_name='inference/qwen2.5-1.5b-instruct-math-3k' \
