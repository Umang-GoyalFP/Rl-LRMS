...
if __name__ == '__main__':
    ...
    path = "/hpc2hdd/home/zyang398/yangzhch6/projs/TreeRPO/TreeRPO-v4/rllm/data/train/math/oneshot.json"
    ...
    process_fn = make_map_fn(split='train', data_source="OneShot")
    ...
    train_df.to_parquet(os.path.join(local_dir, 'train/oneshot.parquet'))
